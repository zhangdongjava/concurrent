!function (t, i) {
    ...
    i.require, s.submit = {
        ...
        "timer" == this.config.type && (i = t.timeShowType), this.button.on("mouseover", function () {
            ...
            t._validate(), 0 === t.getErrno() && ("timer" == t.config.type && (t.config.url ? t._post() : t._timing()), null != t.config.onclick && t.config.onclick(i, this.button))
        ...
        i.button.off("click"), this.button.get(0).className = i.timeShowType.className + " " + i.timeShowType.disabled, t(i.button).html("桶�(" + s + ")");
    ...
    "use strict";
    function s() {
        this.tpl = '<a class="mod-feedback clearfix" id="mod_feedback" href="http://passport.baidu.com/v2/?ucenterfeedback#ucenter_0" target="_blank"><div class="feedback-inner">镣�</div></a>', this.init()
    }
    ...
    i.require, s.prototype.init = function () {
        ...
        var i = baidu("#mod_feedback"), s = baidu(document).children(), e = baidu(document.body).scrollTop(), o = baidu(window).height(), n = baidu.browser.ie < 7;
        n ? (i.hide(), i.css({
            position: "absolute",
            right: "-1px",
            top: e + o / 2 - 40 + "px"
